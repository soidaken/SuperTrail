...
- 这份渲染组件自定义 assembler 的过程是标准实现方法,其他有自定义渲染需求的可以使用这份代码作为模板去修改.
...
#### 如果你有任何不错的功能修改要提交到这个仓库,请联系我 v `soida3`,加你到贡献者列表

#### 如果对你的游戏项目有帮助,心情好请我喝杯美式~~~~~~~

![alt text](mm_reward_qrcode_soida.jpg)
